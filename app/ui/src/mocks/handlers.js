...
export const handlers = [
  ...
  rest.get('/api/scenes/s123/apps/a1/revisions', (req, res, ctx) => {
    return res(
      ctx.json({
        revisions: [
          { entity: 'src/file 1', numberOfRevisions: 23, code: 21 },
          { entity: 'src/file 2', numberOfRevisions: 10, code: 67 },
                ...
                children: [
                  {
                    ...
                    children: [
                      {
                        name: 'command.go',
                        coupling: ['root/business/core/stop-db/command.go'],
                        relations: [
                          {
                  ...
                  },
                  {
                    ...
                    children: [
                      {
                        name: 'command.go',
                        coupling: ['root/business/core/start-db/command.go'],
                        relations: [
                          {
  ...
  rest.get('/api/scenes/s123/apps/a1/boundaries', (req, res, ctx) => {
    return res(
      ctx.json({
        boundaries: [{ id: 'b123', name: 'production/tests' }],
      })
    )
  }),

  rest.get(
    '/api/scenes/s123/apps/a1/boundaries/production/tests/modules',
    (req, res, ctx) => {
      return res(
        ctx.json({
          modules: [
  ...
  rest.get('/api/scenes/s123/apps/a1/revisions-trends', (req, res, ctx) => {
    return res(
      ctx.json({
        trends: [{ id: 'trend1', name: 'architecture-trends' }],
      })
    )
  }),

  rest.get(
    '/api/scenes/s123/apps/a1/revisions-trends/trend1',
    (req, res, ctx) => {
      return res(
        ctx.json({
          trends: [
  ...
  rest.get('/api/scenes/s123/apps/a1/complexity-analyses', (req, res, ctx) => {
    return res(
      ctx.json({
        analyses: [{ id: 'analysis-1', name: 'Analysis 1' }],
      })
    )
  }),

  rest.get(
    '/api/scenes/s123/apps/a1/complexity-analyses/analysis-1',
    (req, res, ctx) => {
      return res(
        ctx.json({
          entries: [
