  ...
  useEffect(() => {
    ...
    const buildRectangles = (contributions) => {
      ...
      const rectangle0 = {
        ...
        width:
          ((contributions[0].contributions / totalContributions) * totalArea) /
      ...
      for (let i = 2; i <= contributions.length; i++) {
        if (i % 2 === 0) {
          rectangles.push({
            ...
            y: rectangles[i - 1].y,
            height:
              ((contributions[i - 1].contributions / totalContributions) *
                totalArea) /
              (rectangles[i - 2].width - rectangles[i - 1].width),
          ...
          rectangles.push({
            ...
            width:
              ((contributions[i - 1].contributions / totalContributions) *
                totalArea) /
              (rectangles[i - 2].height - rectangles[i - 1].height),
            fill: colorScale(i),
          })
        }
      }
